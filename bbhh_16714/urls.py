...
admin.site.site_header = "bbhh"
admin.site.site_title = "bbhh Admin Portal"
admin.site.index_title = "bbhh Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="bbhh API",
        default_version="v1",
        description="API documentation for bbhh App",
    ),
    public=True,
